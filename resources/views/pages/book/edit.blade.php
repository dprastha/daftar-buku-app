   ...
   <div class="card-body card-block">
      <form action="{{ route('book.update', $item->id) }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            name="title" 
            id="title" 
            value="{{ old('title') ? old('title') : $item->title }} " class="form-control @error('title') is-invalid @enderror">
         ...
         <div class="form-group">
            ...
            name="genre" 
            id="genre" 
            value="{{ old('genre') ? old('genre') : $item->genre}}" class="form-control @error('genre') is-invalid @enderror">
         ...
         <div class="form-group">
            ...
            name="pages" 
            id="pages" 
            value="{{ old('pages') ? old('pages') : $item->pages}}" class="form-control @error('pages') is-invalid @enderror">
         ...
         <div class="form-group">
            ...
            name="publish_date" 
            id="publish_date" 
            value="{{ old('publish_date') ? old('publish_date') : $item->publish_date}}" class="form-control @error('publish_date') is-invalid @enderror">
         ...
         <div class="form-group">
            ...
            name="picture" 
            id="picture" 
            value="{{ old('picture') ? old('picture') : $item->picture}} "
            accept="image/*"
